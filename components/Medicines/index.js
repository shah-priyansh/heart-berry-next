      ...
      <div className="page-wrapper">
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="white-bg p-md-5 p-3 d-inline-block">
                  <h1 className="text-theme">Our <span className="text-black">Products</span></h1>
        ...
        <div className="page-content">
          ...
          <section>
            <div className="container">
              <div className="row">
                <div className="col-xl-9 col-lg-12 order-xl-1">
                  ...
                  <div>
                    {selectedValue === '1' && (
                      <>
                        <div className='gap-4 productcard_content'>
                          <Productcard product_data={currentProducts} />
                        </div>
                      </>
                    )}
