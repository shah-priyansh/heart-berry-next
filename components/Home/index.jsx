      ...
      <div className="page-wrapper">
        ...
        <section className="banner p-0 pos-r fullscreen-banner home-bg">
          <div className="banner-slider owl-carousel no-pb" data-dots="false" data-nav="true">
            <div className="item hero-overlay" data-bg-img="assets/images/bg/01.jpeg" data-overlay="6">
              <div className="align-center pt-0">
                <div className="container">
                  <div className="row">
                    <div className="col-lg-6 col-md-10 col-12">
                      <h1 className="mb-4 text-black">Welcome To <span className="text-theme">Heartberry</span> Overseas</h1>
                      <p className="lead font-w-5 text-black">Your Gateway to good helt. We're not just a pharmacy; We're your healthcare partene. With a commitment to quality, affordability, and convenience, we deliver pharmacetutical solutions that put your well-being first. Trust us for a healthier, happier Life."</p>
                      <div className="btn-box mt-5">
                        <Link className="btn btn-theme" href="/about"> <span>More About</span>
                        </Link>
                        <Link className="btn btn-dark" href="#"> <span>Our Service</span>
                        </Link>
                      </div>
                    </div>
                  </div>
            ...
            <div className="item hero-overlay" data-bg-img="assets/images/bg/02.jpeg" data-overlay="6">
              <div className="align-center pt-0">
                <div className="container">
                  <div className="row">
                    <div className="col-lg-6 col-md-10 col-12">
                      <h1 className="mb-4 text-black">Your Health Is<span className="text-theme"> Our Priority</span></h1>
                      <p className="lead font-w-5 text-black">Your Gateway to good helt. We're not just a pharmacy; We're your healthcare partene. With a commitment to quality, affordability, and convenience, we deliver pharmacetutical solutions that put your well-being first. Trust us for a healthier, happier Life."</p>
                      <div className="btn-box mt-5">
                        <Link className="btn btn-theme" href="/about"> <span>More About</span>
                        </Link>
        ...
        <div className="page-content">
              ...
              <div className="row">
                <div className="col-lg-3 col-sm-6">
                  <div className="featured-item style-1 h-100">
                    ...
                    <div className="featured-desc">
                      <p>The quality of our products is a matter of high importance and pride for us. Because some patients get treatment with those medicines.</p>
                    </div>
                  </div>
                </div>
                <div className="col-lg-3 col-sm-6 mt-5 mt-sm-0">
                  <div className="featured-item style-1 active h-100">
                    ...
                    <div className="featured-desc">
                      <p>Our warehouses are located worldwide. Your order will be delivered within the guaranteed delivery time. We assure you of that.</p>
                    </div>
                  </div>
                </div>
                <div className="col-lg-3 col-sm-6 mt-5 mt-lg-0">
                  <div className="featured-item style-1 h-100">
                    ...
                    <div className="featured-desc">
                      <p>If you have any questions about our products, delivery options, or your order status please contact us in any way you prefer.</p>
                    </div>
                  </div>
                </div>
                <div className="col-lg-3 col-sm-6 mt-5 mt-lg-0">
                  <div className="featured-item style-1 h-100">
                    ...
                    <div className="featured-desc">
                      <p>Hello friends join our organization and enjoy another 10% bonus on your advance order.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* <!--global-Precence start--> */}
          <section>
            <div className="container">
              <div className="row align-items-center justify-content-between">
                <div className="col-lg-5 col-12 order-lg-1">
                  <img className="img-fluid" src="assets/images/about/global.jpg" alt="" />
                </div>
                <div className="col-lg-7 col-12 mt-6 mt-lg-0">
                  <div className="row align-items-end">
                    <div className="col-md-7">
                      <div className="section-title">
                        <h2 className="title">Heartberry Overseas Around the Global</h2>
                        <p className="text-black font-w-5 mb-3">We’re here to care for you and your entire family doctor will general health!</p>
                        <p>Heartberry Overseas Privet Limited endeavors to become the World-class Pharmaceutical Exporter for India And Expanded and grown manifold since its inception, We have Operations in over 40+ countries and 5+ countinents globally.</p>
                      </div>
                      <Link className="btn btn-theme" href="/globalpresence"> <span>More About</span>
                      </Link>
                    </div>
                    <div className="col-md-5 mt-6 mt-md-0">
                      <p className="mb-4">Heartberry Overseas Pvt. Ltd's aim is to make the medicines we make available to patients easily. And make it useful.</p>
                      <img className="img-fluid" src="assets/images/sign.png" alt="" />
                      <ul className="list-unstyled list-icon mt-4">
                        <li className="mb-3"><i className="las la-check"></i>Export medicines to 40+ countries</li>
                        <li className="mb-3"><i className="las la-check"></i>200+ International Product</li>
                        <li><i className="las la-check"></i>5 continents globally include </li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div className="row justify-content-center text-center">
                <div className="col-lg-7 col-12">
                  <div className="section-title mb-3">
                    <h2 className="title mb-0">Certain services from us to you and your other family members !</h2>
                  </div>
                </div>
              </div>
              <div className="row">
                    ...
                    <div className="item">
                      <div className="service-item style-1">
                        <div className="service-img mx-4 z-index-1 overflow-hidden">
                          <img className="img-fluid" src="assets/images/service/01.jpeg" alt="" />
                        ...
                        <div className="service-desc white-bg mt-n5 pt-7">
                          ...
                          <p>Every Medicine is Quality Tested 2000 + Product, Near 100% Fullfillment Rate. Most Preferred online Pharmacy.</p> <Link className="link-btn" href="/service"><i className="las la-long-arrow-alt-right"></i></Link>
                        </div>
                      </div>
                    </div>
                    <div className="item">
                      <div className="service-item style-1">
                        <div className="service-img mx-4 z-index-1 overflow-hidden">
                          <img className="img-fluid" src="assets/images/service/03.jpeg" alt="" />
                        ...
                        <div className="service-desc white-bg mt-n5 pt-7">
                          ...
                          <p>You can enjoy any pharmacy service with our professional staff 24/7.</p> <Link className="link-btn" href="/service"><i className="las la-long-arrow-alt-right"></i></Link>
                        </div>
                      </div>
                    </div>
                    <div className="item">
                      <div className="service-item style-1 active">
                        <div className="service-img mx-4 z-index-1 overflow-hidden">
                          <img className="img-fluid" src="assets/images/service/02.jpeg" alt="" />
                        ...
                        <div className="service-desc white-bg mt-n5 pt-7">
                          ...
                          <p>Happy And Hassle-Free User Expeience For Thousands of Customer in More Than 40 countries.</p> <Link className="link-btn" href="/service"><i className="las la-long-arrow-alt-right"></i></Link>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="row">
                      <div className="col-lg-3 col-sm-6">
                        <div className="counter d-flex">
                          ...
                          <div className="counter-desc"> <span className="count-number text-black" data-to="200" data-speed="2000">2000 +</span>
                            <h6>Excellence</h6>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="col-lg-3 col-sm-6 mt-5 mt-lg-0">
                        <div className="counter d-flex">
                          ...
                          <div className="counter-desc"> <span className="count-number text-black" data-to="28" data-speed="2000">28</span>
            ...
            <div className="container-fluid ps-0">
              <div className="row">
                <div className="col-lg-7 col-md-10 col-11">
                  <div className="dark-bg p-lg-7 p-4 pb-10 custom-pt-1" data-bg-img="assets/images/pettern/02.png">
                    <div className="section-title ms-md-5 innovative-content">
                      <h2 className="title">Pharmacy With Innovative Approach To Treatment</h2>
                      <p className="lead text-light">Customer Satisftaction is very important to us and we achieve this by Providing quality Product on Time and at reasonable price. We guarantee that the quality permeates all Product at all stages od devlopment, manufacture, storage, sale, distribution, ect. We are committed to  building and maintaining strong relationships with our Customers around the world. This has established us as a trusted exporter with service around the world.</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="owl-carousel no-pb" data-dots="false" data-items="6" data-md-items="4" data-sm-items="3" data-xs-items="2" data-margin="20" data-autoplay="true">
                    <div className="item">
                      <div className="client-logo">
                        <img className="img-fluid" src="assets/images/clients/09.png" alt="" />
                      </div>
                    </div>
                    <div className="item">
                      <div className="client-logo">
                        <img className="img-fluid" src="assets/images/clients/10.png" alt="" />
                      </div>
                    </div>
                    <div className="item">
                      <div className="client-logo">
                        <img className="img-fluid" src="assets/images/clients/11.png" alt="" />
                      </div>
                    </div>
                    <div className="item">
                      <div className="client-logo">
                        <img className="img-fluid" src="assets/images/clients/12.png" alt="" />
                      </div>
                    </div>
                    <div className="item">
                      <div className="client-logo">
                        <img className="img-fluid" src="assets/images/clients/13.png" alt="" />
                      </div>
                    </div>
                    <div className="item">
                      <div className="client-logo">
                        <img className="img-fluid" src="assets/images/clients/14.png" alt="" />
                      </div>
                    </div>
                    <div className="item">
                      <div className="client-logo">
                        <img className="img-fluid" src="assets/images/clients/15.png" alt="" />
                      </div>
                    </div>
                    <div className="item">
                      <div className="client-logo">
                        <img className="img-fluid" src="assets/images/clients/16.png" alt="" />
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="owl-carousel no-pb popup-gallery" data-dots="false" data-items="5" data-md-items="3" data-sm-items="2" data-xs-items="1" data-margin="10">
                    <div className="item">
                      <div className="cases-item position-relative overflow-hidden">
                        <img className="img-fluid w-100" src="assets/images/product/01.jpg" alt="" />
                        <Link className="popup-img" href="assets/images/project/large/01.jpg"> <i className="las la-plus"></i>
                        </Link>
                        <div className="cases-title"> <span>Pathology</span>
                          <h4><Link href="research-single.html">Personnel Competence</Link></h4>
                        </div>
                      </div>
                    </div>
                    <div className="item">
                      <div className="cases-item position-relative overflow-hidden">
                        <img className="img-fluid w-100" src="assets/images/product/02.jpg" alt="" />
                        <Link className="popup-img" href="assets/images/project/large/02.jpg"> <i className="las la-plus"></i>
                        </Link>
                        <div className="cases-title"> <span>Pathology</span>
                          <h4><Link href="research-single.html">Personnel Competence</Link></h4>
                        </div>
                    ...
                    <div className="item">
                      <div className="cases-item position-relative overflow-hidden">
                        <img className="img-fluid w-100" src="assets/images/product/03.jpg" alt="" />
                        <Link className="popup-img" href="assets/images/project/large/03.jpg"> <i className="las la-plus"></i>
                        </Link>
                        <div className="cases-title"> <span>Pathology</span>
                          <h4><Link href="research-single.html">Personnel Competence</Link></h4>
                        </div>
                    ...
                    <div className="item">
                      <div className="cases-item position-relative overflow-hidden">
                        <img className="img-fluid w-100" src="assets/images/product/04.jpg" alt="" />
                        <Link className="popup-img" href="assets/images/project/large/04.jpg"> <i className="las la-plus"></i>
                        </Link>
                        <div className="cases-title"> <span>Pathology</span>
                          <h4><Link href="research-single.html">Personnel Competence</Link></h4>
                        </div>
                    ...
                    <div className="item">
                      <div className="cases-item position-relative overflow-hidden">
                        <img className="img-fluid w-100" src="assets/images/product/05.jpg" alt="" />
                        <Link className="popup-img" href="assets/images/project/large/05.jpg"> <i className="las la-plus"></i>
                        </Link>
                        <div className="cases-title"> <span>Pathology</span>
                          <h4><Link href="research-single.html">Personnel Competence</Link></h4>
                        </div>
          ...
          <section className="pb-0">
            <div className="container">
              ...
              <div className="row">
                <div className="col">
                  <div className="owl-carousel no-pb client_reviecontent" data-dots="false" data-items="3" data-xl-items="2" data-md-items="2" data-sm-items="1" data-xs-items="1" data-margin="24" data-autoplay="true">
                    {
                      clients_review.map((props) => {
                        return (
                          <>
                            <div className="item ">
                              <div className='border rounded p-4 h-100 '>
                                <div className='d-flex align-items-center justify-content-between'>
                                  <div className='d-flex align-items-center gap-3 client-profile'>
                                    <div><img src={props.clients_img} className='rounded-circle' alt='' /></div>
                                    <div>
                                      <h6 className='font-w-6 mb-0'>{props.name}</h6>
                                      <p className='mb-0'>{props.city}</p>
                                    </div>
                                  </div>
                                  <img src='assets/images/qutes.svg' className='' alt='' />
                                </div>
          ...
          <section>
            <div className='container'>
              ...
              <form id="contact-form" className="row p-4 rounded mx-auto enquiry_content" method="post" action="php/contact.php">
                ...
                <div className="form-group col-md-6">
                  ...
                  <input id="form_email" type="email" name="email" className="form-control" placeholder="Enter Your Emial" required="required" />
                </div>
                <div className="form-group col-md-6">
                  <label className='font-w-6 mb-1'>Phone Number</label>
                  <input id="form_phone" type="tel" name="phone" className="form-control" placeholder="Enter Your Phone Number" required="required" />
                </div>
                <div className="form-group col-md-6">
                ...
                <div className="form-group col-md-12">
                  ...
                  <input id="form_intrestedproduct" type="text" name="intrestedproduct" className="form-control" placeholder="Enter Your Intrested Product" required="required" />
                </div>
                <div className="form-group col-md-12">
                  <label className='font-w-6 mb-1'>Write a Massege</label>
                  <textarea id="form_message" name="message" className="form-control" placeholder="Your Helth Condition..." rows="3" required="required"></textarea>
                </div>
                <div className="col-md-12 text-center mt-4">
                  <button className="btn btn-theme"><span>Send Enquiry</span>
                  </button>
                </div>
              </form>
            </div>
